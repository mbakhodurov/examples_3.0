...
const (
	AnalysisService_AnalyzeSighting_FullMethodName = "/analysis.v1.AnalysisService/AnalyzeSighting"
)
...
//
// AnalysisService сервис анализа наблюдений НЛО
type AnalysisServiceClient interface {
	// AnalyzeSighting выполняет анализ наблюдения НЛО
...
func (c *analysisServiceClient) AnalyzeSighting(ctx context.Context, in *AnalyzeSightingRequest, opts ...grpc.CallOption) (*AnalyzeSightingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AnalyzeSightingResponse)
	err := c.cc.Invoke(ctx, AnalysisService_AnalyzeSighting_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAnalysisServiceServer) AnalyzeSighting(context.Context, *AnalyzeSightingRequest) (*AnalyzeSightingResponse, error) {
...
func _AnalysisService_AnalyzeSighting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnalyzeSightingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalysisServiceServer).AnalyzeSighting(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AnalysisService_AnalyzeSighting_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalysisServiceServer).AnalyzeSighting(ctx, req.(*AnalyzeSightingRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AnalysisService_AnalyzeSighting_Handler,
		},
	},
