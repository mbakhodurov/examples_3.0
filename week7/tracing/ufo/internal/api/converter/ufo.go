...
func CreateRequestToInput(req *ufov1.CreateRequest) input.CreateSightingInput {
	...
	if req.ObservedAt != nil {
		observedAt = lo.ToPtr(req.ObservedAt.AsTime()) //new(req.ObservedAt.AsTime())
	}
...
// UpdateRequestToInput преобразует плоский запрос обновления наблюдения во вход use case'а
...
// SightingToDTO конвертирует доменную модель наблюдения в плоский транспортный DTO
