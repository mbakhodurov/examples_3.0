...
import (
	...
	"github.com/mbakhodurov/examples2/week_6/redis/clean_arch/platform/pkg/grpc/health"
	"github.com/mbakhodurov/examples2/week_6/redis/clean_arch/platform/pkg/logger"
...
func (a *App) initGRPCServer(ctx context.Context) {
	...
	// зацепит за собой создание пула БД и Redis-клиента и зарегистрирует их в closer'е.
